...
export default function Experience() {
  return (
    <Container>
      ...
      <div id='interseed' className="py-8 px-8 mb-10 bg-neutral-50 dark:bg-neutral-900 shadow-lg hover:shadow-2xl transition-shadow rounded-xl text-gray-600 dark:text-gray-400 sm:text-xl">
        <h3 className="font-bold text-3xl sm:text-4xl text-gray-800 dark:text-gray-200">Interseed.co</h3>
        <h4 className="font-semibold text-2xl sm:text-3xl mb-4 text-gray-800 dark:text-gray-200">Front-End Engineer</h4>
        <p>
        ...
        <p className="mt-4">
          ...
          <Link href='https://app.interseed.co'>
            <a target='_blank' rel='noopener noreferrer' className="text-indigo-600 dark:text-indigo-400">app.interseed.co</a>
          </Link>
          !
        </p>
      ...
      <div id='sgcc' className="py-8 px-8 mb-10 bg-neutral-50 dark:bg-neutral-900 shadow-lg hover:shadow-2xl transition-shadow rounded-xl text-gray-600 dark:text-gray-400 sm:text-xl">
        ...
        <p>
          ...
          <Link href='https://www.sgcodecampus.com/datascience-bootcamp-accelerator-2021/'>
            <a target='_blank' rel='noopener noreferrer' className="text-indigo-600 dark:text-indigo-400">IMDA&ndash;AWS Data Science Bootcamp and Accelerator Programme</a>
          </Link>
          ...
          <Link href='https://academy.smu.edu.sg/advanced-diploma-python-programming-and-applied-data-analytics-4731'>
            <a target='_blank' rel='noopener noreferrer' className="text-indigo-600 dark:text-indigo-400">Advanced Diploma in Python Programming and Applied Data Analytics</a>
          </Link>
          &nbsp;certification.
        </p>

        <h4 className="font-semibold text-2xl sm:text-3xl my-4 text-gray-800 dark:text-gray-200">Curriculum Developer</h4>
        <p>
        ...
        <h4 className="font-semibold text-2xl sm:text-3xl my-4 text-gray-800 dark:text-gray-200">Deep Learning Intern</h4>
        <p>
      ...
      <div id='nestedai' className="py-8 px-8 mb-10 bg-neutral-50 dark:bg-neutral-900 shadow-lg hover:shadow-2xl transition-shadow rounded-xl text-gray-600 dark:text-gray-400 sm:text-xl">
