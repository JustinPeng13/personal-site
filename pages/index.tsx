    ...
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
        ...
        <div className="flex align-bottom self-center">
          <div className="h-60 max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-20 md:mt-0 md:mb-10 md:pr-16">
            <div className="flex justify-center -mt-16 md:hidden">
              <Image className="object-cover rounded-full border-2 border-indigo-500" width='80px' height='80px' src="/assets/interseed.jpg" />
            </div>
            <div>
            ...
            <div className="justify-end mt-3 text-indigo-700 font-medium">
              2022-Present
            </div>
          </div>
          <div className="hidden mt-8 -ml-10 md:block">
            <Image className="object-cover rounded-full border-2 border-indigo-500" width='180px' height='180px' src="/assets/interseed.jpg" />
          </div>
        </div>
        {/* SGCC */}
        <div className="flex align-bottom self-center">
          <div className="hidden mt-8 -mr-10 md:block">
            <Image className="object-cover rounded-full border-2 border-indigo-500" width='180px' height='180px' src="/assets/sgcc.png" />
          </div>
          <div className="text-right h-60 max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-20 md:mt-0 md:pl-16">
            <div className="flex justify-center -mt-16 md:hidden">
              <Image className="object-cover rounded-full border-2 border-indigo-500" width='80px' height='80px' src="/assets/sgcc.png" />
            </div>
            <div>
            ...
            <div className="justify-end mt-4 text-indigo-700 font-medium">
              2021-Present
            </div>
          </div>
        </div>
        ...
        <h3 className="font-bold text-3xl md:text-4xl mb-4 mt-16 text-black dark:text-white">
          Personal Projects
        </h3>
