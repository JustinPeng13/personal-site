...
export default function Projects() {
  return (
    <Container>
      ...
      <div id='tsp' className="py-8 px-8 mb-10 bg-neutral-50 dark:bg-neutral-900 shadow-lg hover:shadow-2xl transition rounded-xl text-gray-600 dark:text-gray-400 sm:text-xl">
