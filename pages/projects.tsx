...
export default function Projects() {
  return (
    <Container>
      ...
      <div id='tsp' className="py-8 px-8 mb-10 bg-neutral-50 dark:bg-neutral-900 shadow-lg hover:shadow-2xl transition rounded-xl text-gray-600 dark:text-gray-400 text-xl">
        <h3 className="font-bold text-3xl md:text-4xl text-gray-800 dark:text-gray-200">TheSocialPitstop</h3>
        <h4 className="font-semibold text-2xl md:text-3xl mb-4 text-gray-800 dark:text-gray-200">Full-Stack Engineer</h4>
        <p>
        ...
        <p className="mt-4">
          ...
          <Link href='https://theocialpitstop.vercel.app'>
            <a target='_blank' rel='noopener noreferrer' className="text-blue-500">thesocialpitstop.vercel.app</a>
          </Link>
          ! Or, find out more in our&nbsp;
          <Link href='https://drive.google.com/file/d/1kQQVBpxuSU_z89ssI2WwCHQYkDbXFrtH/view'>
            <a target='_blank' rel='noopener noreferrer' className="text-blue-500">poster</a>
          </Link>
          ,&nbsp;
          <Link href='https://docs.google.com/document/d/1Dh9ryDYsRjsHrujdwJpr1zloDwOYwzn6lRG0et53ZTU/view'>
            <a target='_blank' rel='noopener noreferrer' className="text-blue-500">report</a>
          </Link>
          , and&nbsp;
          <Link href='https://drive.google.com/file/d/1OqlYS0FW7DZ8w9aDWZRZeHCZrDRqwPmb/view'>
            <a target='_blank' rel='noopener noreferrer' className="text-blue-500">video</a>
          </Link>
          !
        </p>
