  ...
  return (
    <Container>
      ...
      >
        ...
        <p>
          TheSocialPitstop is an online community that connects businesses and
          socially-oriented organisations for corporate social responsibility
          project partnerships. I built the platform over 3 months together with
          a coursemate, and it was awarded the Orbital &ndash; Apollo 11
          (Advanced) certification by NUS.
        </p>
        <p className="mt-4">
          Check us out at&nbsp;
        ...
        <p>
          <em>
            <b>Tech Used</b>: Next.js, Vercel, AWS, Terraform, GraphQL, Auth0,
            Algolia, Jest, Cypress, Github Actions
          </em>
        </p>
      </div>
    </Container>
